...
//首页统计
const getBuyAndSaleStatistics = (params)=>getAction("/receipts/getBuyAndSaleStatistics",params);
const buyOrSalePrice = (params)=>getAction("/receiptsItem/buyOrSalePrice",params);
//商户管理
...
//单据相关
const findBillDetailByNumber = (params)=>getAction("/receipts/getDetailByNumber",params);
const findStockByDepotAndBarCode = (params)=>getAction("/receiptsItem/findStockByDepotAndBarCode",params);
const getBatchNumberList = (params)=>getAction("/receiptsItem/getBatchNumberList",params);
