              ...
              <a-col :md="24" :sm="24">
                <a-dropdown>
                  <a-menu slot="overlay">
                    ...
                    <a-menu-item v-if="isTenant" key="2" @click=""><a-icon type="plus"/>新增仓库</a-menu-item>
                  </a-menu>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: '/receipts/addReceiptsAndDetail',
          edit: '/receipts/updateDepotHeadAndDetail',
          detailList: '/receiptsItem/getDetailList'
        }
      }
    },
    created () {
