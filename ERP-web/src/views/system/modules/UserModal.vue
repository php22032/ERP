    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form" id="userModal">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="角色">
          <a-select v-if="model.roleName!='商户'" placeholder="选择角色" v-decorator="[ 'roleId', validatorRules.roleId]" :dropdownMatchSelectWidth="false">
            <a-select-option v-for="(item,index) in roleList" :key="index" :value="item.id">
              {{ item.name }}
            </a-select-option>
          </a-select>
          <a-col v-if="model.roleName=='商户'"><a-row>商户</a-row></a-col>
        </a-form-item>
