        ...
        <div class="table-page-search-wrapper">
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="商户类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-select v-model="queryParam.type" placeholder="请选择商户类型">
                    <a-select-option value="0">免费商户</a-select-option>
                    <a-select-option value="1">付费商户</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="商户状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
        ...
        <div>
          <a-table
            ...
            <template slot="customRenderType" slot-scope="type">
              <a-tag v-if="type==0">免费商户</a-tag>
              <a-tag v-if="type==1" color="green">付费商户</a-tag>
            </template>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          { title: '商户类型',dataIndex: 'type',width:70,align:"center",
            scopedSlots: { customRender: 'customRenderType' }
          },
          { title: '商户状态',dataIndex: 'enabled',width:70,align:"center",
