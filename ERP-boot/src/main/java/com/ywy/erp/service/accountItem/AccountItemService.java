...
import com.ywy.erp.entities.AccountItem;
import com.ywy.erp.entities.AccountItemExample;
import com.ywy.erp.entities.User;
import com.ywy.erp.mappers.AccountItemMapper;
import com.ywy.erp.mappers.AccountItemMapperEx;
import com.ywy.erp.vo.AccountItemVo4List;
        ...
        if (null != rowArr && rowArr.size()>0) {
            for (int i = 0; i < rowArr.size(); i++) {
                ...
                if (tempInsertedJson.get("billNumber") != null && !tempInsertedJson.get("billNumber").equals("")) {
                    ...
                    accountItem.setBillId(receiptsService.getReceipts(billNo).getId());
                }
