...
public class AccountService {
    ...
    public int batchDeleteAccountByIds(String ids) throws Exception{
        ...
        try{
            receiptsList = receiptsMapperEx.getReceiptsListByAccountIds(idArray);
        }catch(Exception e){
            JshException.readFail(logger, e);
        }
    ...
    public BigDecimal getAccountSum(Long id, String timeStr, String type) throws Exception{
        ...
        try {
            ...
            List<Receipts> dataList=null;
            try{
                dataList = receiptsMapper.selectByExample(example);
            }catch(Exception e){
                JshException.readFail(logger, e);
            }
            if (dataList != null) {
                for (Receipts receipts : dataList) {
                    if(receipts.getChangeAmount()!=null) {
                        accountSum = accountSum .add(receipts.getChangeAmount()) ;
                    }
                }
            }
    ...
    public BigDecimal getManyAccountSum(Long id, String timeStr, String type)throws Exception {
        ...
        try {
            ...
            if (dataList != null) {
                for (Receipts receipts : dataList) {
                    String accountIdList = receipts.getAccountIdList();
                    String accountMoneyList = receipts.getAccountMoneyList();
