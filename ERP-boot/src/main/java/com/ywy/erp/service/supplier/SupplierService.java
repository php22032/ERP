...
import com.ywy.erp.mappers.AccountHeadMapperEx;
import com.ywy.erp.mappers.ReceiptsMapperEx;
import com.ywy.erp.mappers.SupplierMapper;
import com.ywy.erp.mappers.SupplierMapperEx;
...
import com.ywy.erp.service.userBusiness.UserBusinessService;
...
public class SupplierService {
    ...
    public List<Supplier> select(String supplier, String type, String phonenum, String telephone, int offset, int rows) throws Exception{
        ...
        try{
            ...
            for(Supplier s : list) {
                ...
                sum = sum.add(receiptsService.findTotalPay(supplierId, endTime, supType))
    ...
    public int batchDeleteSupplierByIds(String ids)throws Exception {
        ...
        //校验单据主表	receipts
        List<Receipts> receiptsList=null;
        try{
            receiptsList = receiptsMapperEx.getReceiptsListByOrganIds(idArray);
        }catch(Exception e){
            JshException.readFail(logger, e);
        }
