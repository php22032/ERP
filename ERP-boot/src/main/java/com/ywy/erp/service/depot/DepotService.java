...
import com.ywy.erp.mappers.DepotMapper;
import com.ywy.erp.mappers.DepotMapperEx;
...
public class DepotService {
    ...
    public int batchDeleteDepotByIds(String ids)throws Exception {
        ...
        try{
            receiptsItemList = receiptsItemMapperEx.getReceiptsItemListListByDepotIds(idArray);
        }catch(Exception e){
            JshException.readFail(logger, e);
        }
