...
import com.ywy.erp.entities.AccountHead;
import com.ywy.erp.entities.Receipts;
import com.ywy.erp.entities.Person;
import com.ywy.erp.entities.PersonExample;
import com.ywy.erp.mappers.AccountHeadMapperEx;
import com.ywy.erp.mappers.ReceiptsMapperEx;
import com.ywy.erp.mappers.PersonMapper;
import com.ywy.erp.mappers.PersonMapperEx;
...
public class PersonService {
    ...
    public int batchDeletePersonByIds(String ids)throws Exception {
        ...
        try{
            receiptsList=receiptsMapperEx.getReceiptsListByCreator(idArray);
        }catch(Exception e){
            JshException.readFail(logger, e);
        }
