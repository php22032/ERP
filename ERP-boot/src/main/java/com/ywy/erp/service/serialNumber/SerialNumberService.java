...
import com.ywy.erp.mappers.MaterialMapper;
import com.ywy.erp.mappers.MaterialMapperEx;
import com.ywy.erp.mappers.SerialNumberMapper;
import com.ywy.erp.mappers.SerialNumberMapperEx;
...
public class SerialNumberService {
     ...
     * @Param: List<ReceiptsItem>
     * @return void
     */
    public void checkAndUpdateSerialNumber(ReceiptsItem receiptsItem, String outBillNo, User userInfo, String snList) throws Exception{
        if(receiptsItem!=null){
            sellSerialNumber(receiptsItem.getMaterialId(), outBillNo, snList,userInfo);
        }
    }
    /**
     *
     ...
     * @return com.ywy.erp.datasource.entities.SerialNumberEx
     */
    @Transactional(value = "transactionManager", rollbackFor = Exception.class)
