...
import com.ywy.erp.entities.SerialNumber;
import com.ywy.erp.entities.SerialNumberEx;
...
public interface SerialNumberMapperEx {
    ...
    /**
     * 赎回：update serial_number set is_Sell='0',depothead_Id=null  where 1=1 and material_Id='materialId'
